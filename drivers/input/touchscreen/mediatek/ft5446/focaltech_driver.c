...
#define GESTURE_Z		    0x65//0x41  //wenggaojian@wind-mobi.com 20150813
...
static int fts_read_Gestruedata(void)
{
    ...
    /* FW */
/* wenggaojian@wind-mobi.com 20150716 begin */
//start gestrue mode from FW 
...
/* wenggaojian@wind-mobi.com 20150716 end */
    if (0x24 == buf[0])
 ...
 static int fts_init_gpio_hw(void)
{
 ...
 {	 
	...
	char data;
	u8 report_rate=0;
	int err=0;  //wenggaojian@wind-mobi.com 20150716 
	int reset_count = 0;
...
reset_proc:   
	...
	mt_set_gpio_dir(GPIO_CTP_RST_PIN, GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_CTP_RST_PIN, GPIO_OUT_ZERO);  
	msleep(5); //wenggaojian@wind-mobi.com 20150716
	TPD_DMESG(" fts reset\n");
	printk(" fts reset\n");
	mt_set_gpio_mode(GPIO_CTP_RST_PIN, GPIO_CTP_RST_PIN_M_GPIO);
	mt_set_gpio_dir(GPIO_CTP_RST_PIN, GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_CTP_RST_PIN, GPIO_OUT_ONE);
#endif
	msleep(400); //wenggaojian@wind-mobi.com 20150716
	mt_set_gpio_mode(GPIO_CTP_EINT_PIN, GPIO_CTP_EINT_PIN_M_EINT);
	mt_set_gpio_dir(GPIO_CTP_EINT_PIN, GPIO_DIR_IN);
	mt_set_gpio_pull_enable(GPIO_CTP_EINT_PIN, GPIO_PULL_ENABLE);
	mt_set_gpio_pull_select(GPIO_CTP_EINT_PIN, GPIO_PULL_UP);
/* wenggaojian@wind-mobi.com 20150716 begin */
//if is not ft TP power down 
	err = i2c_smbus_read_i2c_block_data(i2c_client, 0x00, 1, &data);
	DBG("tpd_probe:err %d,data:%d\n", err,data);
...
/* wenggaojian@wind-mobi.com 20150716 begin */
	...
	memset(g_dma_buff_va, 0, 4096);
       ...
       //fts_init_gpio_hw(); //wenggaojian@wind-mobi.com 20150716
...
/*dixiaobing@wind-mobi.com 20150603 end*/
	...
	tpd_halt = 0;
/* wenggaojian@wind-mobi.com 20150716 begin */
// clear touch points when resume
	input_report_key(tpd->dev,BTN_TOUCH,0);
	input_mt_sync(tpd->dev);
	input_sync(tpd->dev);
	printk("TPD clear all touch point.\n");
/* wenggaojian@wind-mobi.com 20150716 end */
 ...
 static void tpd_suspend( struct early_suspend *h )
 {
	 ...
	 int i =0;
	 u8 state,state_g; //wenggaojian@wind-mobi.com 20150716 
...
/* wenggaojian@wind-mobi.com 20150716 begin */
	...
	/*			  if(i>=9)
			...
			i2c_smbus_read_i2c_block_data(i2c_client, 0xd0, 1, &state);
			i2c_smbus_read_i2c_block_data(i2c_client, 0xd8, 1, &state_g);  //wenggaojian@wind-mobi.com 20150716 
			printk("tpd fts_read_gesture ok data state=%d,d8 state_g= %d\n",state,state_g); //wenggaojian@wind-mobi.com 20150716 
	       	 return;
	...
	hwPowerDown(TPD_POWER_SOURCE,"TP");
#else
	fts_write_reg(i2c_client, 0xA5, 3);  //TP enter sleep mode  //wenggaojian@wind-mobi.com  201507017
#endif
	mutex_unlock(&i2c_access);
