...
#define N_SCFG2					0x283				// bit0~3 is sense seting
#define N_OFR1					0x0000			// offset
#define N_OFR2					0x0017			// offset
#define N_OFR3					0x0000			// offset
#define N_THR0					0x141A			//S1 press thred setting
#define N_THR1					0x141A			//S2 press thred setting
#define N_THR2					0x141A			//S3 press thred setting
#define N_THR3					0x141A			//S4 press thred setting
#define N_THR4					0x141A			//S5 press thred setting
#define N_THR5					0x141A			//S6 press thred setting
