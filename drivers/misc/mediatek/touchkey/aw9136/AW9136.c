...
// IO PIN DEFINE
//////////////////////////////////////
//#define AW9136_PDN          (GPIO16|0x80000000)
#define AW9136_EINT_NUM     CUST_EINT_CP128_EINT_NUM
#define AW9136_EINT_PIN     GPIO_CP281_EINT_PIN//(GPIO2|0x80000000)
...
static void AW9136_ts_pwron(void)
{
   ...
   // mt_set_gpio_dir(AW9136_PDN,GPIO_DIR_OUT);
	...
	mt_set_gpio_mode(GPIO_CP281_RST_PIN, GPIO_CP281_RST_PIN_M_GPIO);
	mt_set_gpio_dir(GPIO_CP281_RST_PIN, GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_CP281_RST_PIN, GPIO_OUT_ONE);
    msleep(20);
}
...
static void AW9136_ts_pwroff(void)
{
	   // mt_set_gpio_out(AW9136_PDN,GPIO_OUT_ZERO);  
		mt_set_gpio_out(GPIO_CP281_RST_PIN, GPIO_OUT_ZERO);
}
...
// report BACK-BTN single click 
/////////////////////////////////////////////
static void AW_right_release(void)
{
...
int AW9136_ts_setup_eint(void)
{
    ...
    mt_set_gpio_mode(AW9136_EINT_PIN, GPIO_CP281_EINT_PIN_M_GPIO);//eint mode
