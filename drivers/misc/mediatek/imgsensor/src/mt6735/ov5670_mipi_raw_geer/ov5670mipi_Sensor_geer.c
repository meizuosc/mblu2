...
static kal_uint32 OV5670_capture_shutter_geer = 1;
static kal_uint32 OV5670_longexp_linelength_geer = 1676;
static kal_uint16 OV5670_capture_gain_geer = 64;
static kal_uint8 OV5670_long_exp_flag_geer = 0;
//add end
...
//Flyme_EDIT ldx@meizu.com modify for longexp
	...
	write_cmos_sensor(0x3500, (shutter >> 12) & 0x0F);	
       ...
       if(shutter < imgsensor_info.max_frame_length - imgsensor_info.margin) {
            ...
            if(OV5670_longexp_linelength_geer> 0) {
                line_length = OV5670_longexp_linelength_geer;
            } else {
...
//		write_cmos_sensor(0x450a, 0x00);  // 
		...
		write_cmos_sensor(0x0100, 0x00); 
//Flyme_EDIT ldx@meizu.com modify for longexp
              if(OV5670_long_exp_flag_geer) {
                longexp_setting(OV5670_capture_shutter_geer, OV5670_capture_gain_geer);
              } else {
                write_cmos_sensor(0x3501, 0x5f); //long exposure
                write_cmos_sensor(0x3502, 0xd0);  //long exposure
...
//Flyme_EDIT ldx@meizu.com add for longexp
	OV5670_long_exp_flag_geer= 0;
	OV5670_capture_shutter_geer= 1;
	OV5670_capture_gain_geer= 64;
	OV5670_longexp_linelength_geer= 1676;
//add end
	spin_unlock(&imgsensor_drv_lock);
...
//Flyme_EDIT ldx@meizu.com add for longexp
              case SENSOR_FEATURE_SET_LONGEXP_PARAM:
                OV5670_capture_shutter_geer= *feature_data;
                OV5670_longexp_linelength_geer= *(feature_data + 1);
                OV5670_capture_gain_geer= (*(feature_data + 2)) & 0xffff;
                OV5670_long_exp_flag_geer = 1;
                LOG_INF("SENSOR_FEATURE_SET_LONGEXP_PARAM shutter=%d, linelength = %d,Gain=%d\n",
                    OV5670_capture_shutter_geer,OV5670_longexp_linelength_geer,OV5670_capture_gain_geer);
                break;
