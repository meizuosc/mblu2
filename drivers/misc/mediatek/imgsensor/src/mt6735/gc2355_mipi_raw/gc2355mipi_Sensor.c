...
static imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,//sensor output first pixel color //oujiacheng@wind-mobi.com 2015.5.26 modify
...
#define ANALOG_GAIN_7 470  // 7.15x
	...
	//write_cmos_sensor(0xb1, 0x01); //oujiacheng@wind-mobi.com 2015.5.26 remove
	//write_cmos_sensor(0xb2, 0x00); //oujiacheng@wind-mobi.com 2015.5.26 remove
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17,0x17);//14  //oujiacheng@wind-mobi.com 2015.5.26 modify
