...
static kal_uint32 S5K3L2XX_capture_shutter = 1;
static kal_uint32 S5K3L2XX_longexp_linelength = 4512;
static kal_uint16 S5K3L2XX_capture_gain = 64;
static kal_uint8 S5K3L2XX_long_exp_flag = 0;
//modify end
...
//Flyme_EDIT ldx@meizu.com add for longexp
       if(shutter >= MAX_EXP_LINES && IMGSENSOR_MODE_CAPTURE == imgsensor.sensor_mode) {
            ...
            line_length = S5K3L2XX_longexp_linelength;
	}
	else {
...
//Flyme_EDIT ldx@meizu.com modify for longexp
    if(S5K3L2XX_long_exp_flag) {
        longexp_setting(S5K3L2XX_capture_shutter, S5K3L2XX_capture_gain);
    } else {
...
//Flyme_EDIT ldx@meizu.com modify for longexp
    S5K3L2XX_long_exp_flag = 0;
    S5K3L2XX_capture_shutter = 1;
    S5K3L2XX_longexp_linelength = 4512;
    S5K3L2XX_capture_gain = 64;
//add end
    spin_unlock(&imgsensor_drv_lock);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_LONGEXP_PARAM:
            S5K3L2XX_capture_shutter = *feature_data;
            S5K3L2XX_longexp_linelength = *(feature_data + 1);
            S5K3L2XX_capture_gain = (*(feature_data + 2)) & 0xffff;
            S5K3L2XX_long_exp_flag = 1;
            LOG_INF("SENSOR_FEATURE_SET_LONGEXP_PARAM shutter=%d, linelength = %d,Gain=%d\n",
                S5K3L2XX_capture_shutter,S5K3L2XX_longexp_linelength,S5K3L2XX_capture_gain);
            break;
