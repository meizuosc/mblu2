...
extern void S5K3L2_write_cmos_sensor_eeprom(kal_uint32 addr, kal_uint32 para);
extern kal_uint16 S5K3L2_read_cmos_sensor_eeprom(kal_uint32 addr);
typedef struct {
#if 0
...
static int read_cmos_sensor(kal_uint16 slave_id,kal_uint32 addr,u8* data)
{
    ...
    return iReadRegI2C(pu_send_cmd, 1, data, 1, slave_id);
}
...
void S5K3L2_write_cmos_sensor_eeprom(kal_uint32 addr, kal_uint32 para)
{
...
kal_uint16 S5K3L2_read_cmos_sensor_eeprom(kal_uint32 addr)
{
...
void read_s5k3l2_eeprom_awb(void)
{
 kal_uint32  rg_ratio;
 kal_uint32  bg_ratio;
 kal_uint32  grgb_ratio;
 kal_uint32  golden_rg_ratio;
 kal_uint32  golden_bg_ratio;
 kal_uint32  golden_grgb_ratio;
 kal_uint32 R_gain, Gr_gain, Gb_gain, B_gain;
