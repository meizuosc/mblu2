...
#define AF_DRVNAME "BU6429116109AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x18
#define PLATFORM_DRIVER_NAME "lens_actuator_bu6429116109af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_bu6429116109af"
...
inline static int getAFInfo(__user stBU6429116109AF_MotorInfo * pstMotorInfo)
{
    stBU6429116109AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stBU6429116109AF_MotorInfo)))
    {
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case BU6429116109AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stBU6429116109AF_MotorInfo *)(a_u4Param));
        break;
        case BU6429116109AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case BU6429116109AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case BU6429116109AFIOC_T_SETMACROPOS :
...
static int __init BU6429116109AF_i2C_init(void)
{
...
static void __exit BU6429116109AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(BU6429116109AF_i2C_init);
module_exit(BU6429116109AF_i2C_exit);

MODULE_DESCRIPTION("BU6429116109AF lens module driver");
