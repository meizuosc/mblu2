...
#define AF_DRVNAME "BU642911501AF"
#define I2C_SLAVE_ADDRESS        0x16
#define I2C_REGISTER_ID            0x18
#define PLATFORM_DRIVER_NAME "lens_actuator_BU642911501AF"
#define AF_DRIVER_CLASS_NAME "actuatordrv_BU642911501AF"
...
inline static int getAFInfo(__user stBU642911501AF_MotorInfo * pstMotorInfo)
{
    stBU642911501AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stBU642911501AF_MotorInfo)))
    {
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case BU642911501AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stBU642911501AF_MotorInfo *)(a_u4Param));
        break;
        case BU642911501AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case BU642911501AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case BU642911501AFIOC_T_SETMACROPOS :
...
static int AF_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    g_pstAF_I2Cclient->addr = 0x18;//I2C_SLAVE_ADDRESS;
...
static int __init BU642911501AF_i2C_init(void)
{
...
static void __exit BU642911501AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(BU642911501AF_i2C_init);
module_exit(BU642911501AF_i2C_exit);

MODULE_DESCRIPTION("BU642911501AF lens module driver");
