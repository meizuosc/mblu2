...
/*----------------------------------------------------------------------------*/
static int LIS3DH_ReadSensorData_mag(struct i2c_client *client, char *buf, int bufsize);
...
/*oujiacheng@wind-mobi.com 2015.6.30 begin*/
static int LIS3DH_ReadSensorData_mag(struct i2c_client *client, char *buf, int bufsize)
{
...
/*dixiaobing@wind-mobi.com 20150617 end*/
	...
	{
	/*dixiaobing@wind-mobi.com 20150617 start*/
#if 0//def GSENSOR_FACTORY_CALIBRATION
					  for(i=1;i<=20;i++)
					   {
						   udelay(10);
						   LIS3DH_ReadData(client, obj->data);
						   sumx = sumx+obj->data[LIS3DH_AXIS_X];
						   sumy = sumy+obj->data[LIS3DH_AXIS_Y];
						   sumz = sumz+obj->data[LIS3DH_AXIS_Z];
					   }
		
					   obj->data[LIS3DH_AXIS_X] = sumx/20;
					   obj->data[LIS3DH_AXIS_Y] = sumy/20;
					   obj->data[LIS3DH_AXIS_Z] = sumz/20;
...
#endif
	/*dixiaobing@wind-mobi.com 20150617 end*/
	//	printk("dixiaobinggsensor1111   obj->data[LIS3DH_AXIS_X]=%d,obj->data[LIS3DH_AXIS_Y]=%d,obj->data[LIS3DH_AXIS_Z]=%d",obj->data[LIS3DH_AXIS_X],obj->data[LIS3DH_AXIS_Y],obj->data[LIS3DH_AXIS_Z]);
		/*remap coordinate*/
...
//		printk("dixiaobinggsensor2222   acc[obj->cvt.map[LIS3DH_AXIS_X]]=%d,acc[obj->cvt.map[LIS3DH_AXIS_Y]]=%d,acc[obj->cvt.map[LIS3DH_AXIS_Z]]=%d",acc[obj->cvt.map[LIS3DH_AXIS_X]],acc[obj->cvt.map[LIS3DH_AXIS_Y]],acc[obj->cvt.map[LIS3DH_AXIS_Z]]);
	...
	/*dixiaobing@wind-mobi.com 20150617 start*/
#if 0 //def GSENSOR_FACTORY_CALIBRATION
	    acc[LIS3DH_AXIS_X] +=acc_x_cali_value;
		acc[LIS3DH_AXIS_Y] +=acc_y_cali_value;
		acc[LIS3DH_AXIS_Z] +=acc_z_cali_value;
#endif
	//printk("dixiaobinggsensor333	acc[LIS3DH_AXIS_X]=%d,acc[LIS3DH_AXIS_Y]=%d,acc[LIS3DH_AXIS_Z]=%d",acc[LIS3DH_AXIS_X],acc[LIS3DH_AXIS_Y],acc[LIS3DH_AXIS_Z]);
	/*dixiaobing@wind-mobi.com 20150617 end*/
...
/*oujiacheng@wind-mobi.com 2015.6.30 end*/
...
/*dixiaobing@wind-mobi.com 20150617 end*/
...
#endif
	/*dixiaobing@wind-mobi.com 20150617 end*/
		//printk("dixiaobinggsensor1111   obj->data[LIS3DH_AXIS_X]=%d,obj->data[LIS3DH_AXIS_Y]=%d,obj->data[LIS3DH_AXIS_Z]=%d\n",obj->data[LIS3DH_AXIS_X],obj->data[LIS3DH_AXIS_Y],obj->data[LIS3DH_AXIS_Z]);
		/*remap coordinate*/
		acc[obj->cvt.map[LIS3DH_AXIS_X]] = obj->cvt.sign[LIS3DH_AXIS_X]*obj->data[LIS3DH_AXIS_X];
		acc[obj->cvt.map[LIS3DH_AXIS_Y]] = obj->cvt.sign[LIS3DH_AXIS_Y]*obj->data[LIS3DH_AXIS_Y];
		acc[obj->cvt.map[LIS3DH_AXIS_Z]] = obj->cvt.sign[LIS3DH_AXIS_Z]*obj->data[LIS3DH_AXIS_Z];
		...
		//GSE_LOG("Mapped gsensor data: %d, %d, %d!\n", acc[LIS3DH_AXIS_X], acc[LIS3DH_AXIS_Y], acc[LIS3DH_AXIS_Z]);
		//printk("dixiaobinggsensor2222   acc[obj->cvt.map[LIS3DH_AXIS_X]]=%d,acc[obj->cvt.map[LIS3DH_AXIS_Y]]=%d,acc[obj->cvt.map[LIS3DH_AXIS_Z]]=%d\n",acc[obj->cvt.map[LIS3DH_AXIS_X]],acc[obj->cvt.map[LIS3DH_AXIS_Y]],acc[obj->cvt.map[LIS3DH_AXIS_Z]]);
	...
	/*dixiaobing@wind-mobi.com 20150617 start*/
		...
		acc[LIS3DH_AXIS_Z] +=acc_z_cali_value;
#endif
	//printk("dixiaobinggsensor333	acc[LIS3DH_AXIS_X]=%d,acc[LIS3DH_AXIS_Y]=%d,acc[LIS3DH_AXIS_Z]=%d\n",acc[LIS3DH_AXIS_X],acc[LIS3DH_AXIS_Y],acc[LIS3DH_AXIS_Z]);
	/*dixiaobing@wind-mobi.com 20150617 end*/
		sprintf(buf, "%04x %04x %04x", acc[LIS3DH_AXIS_X], acc[LIS3DH_AXIS_Y], acc[LIS3DH_AXIS_Z]);
		if(atomic_read(&obj->trace) & ADX_TRC_IOCTL)//atomic_read(&obj->trace) & ADX_TRC_IOCTL
		{
...

{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_READ_SENSORDATA:
			...
			LIS3DH_ReadSensorData_mag(client, strbuf, LIS3DH_BUFSIZE);
			if(copy_to_user(data, strbuf, strlen(strbuf)+1))
			{
				err = -EFAULT;
				break;	  
...
//zhangaifeng@wind-mobi.com 20150105 begin
 #ifdef CONFIG_COMPAT
...
#endif
//zhangaifeng@wind-mobi.com 20150105 end
/*----------------------------------------------------------------------------*/
		...
		struct device_attribute *attr, const char *buf, size_t size)
{
	...
	lis3dh_enable_nodata(acc_enable_value);
		...
		struct device_attribute *attr, char *buf)
{
	 ...
	 while(count <30)
	 {
		...
		sumx = sumx+acc[LIS3DH_AXIS_X];
		sumy = sumy+acc[LIS3DH_AXIS_Y];
		sumz = sumz+acc[LIS3DH_AXIS_Z];
		count++;
	 }
	 x=sumx/30;
	 y=sumy/30;
